...
class Log03 extends StatefulWidget {
  @override
  _Log02State createState() => _Log02State();
}

class _Log02State extends State<Log03> {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('2개의 과거 신고 이력', style: TextStyle(fontWeight: FontWeight.w300, color: Color(0xFF000000))),
